...
介绍一些背景知识，我是在2008年初开始开发pandas的，那时我任职于AQR Capital Management，一家量化投资管理公司，我有许多工作需求都不能用任何单一的工具解决：
...
在本书的[GitHub页面](https://github.com/wesm/pydata-book)，你可以找到包含各章节所有代码实例的Jupyter notebooks。
...
* 国际和地区的PyCon会议 [http://pycon.org](http://pycon.org) 有完整列表 。
...
伪代码（Pseudocode） 算法或过程的“代码式”描述，而这些代码本身并不是实际有效的源代码。
